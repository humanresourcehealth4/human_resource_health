...
$$
NHS\underset{r,t}{} = SD\underset{r,t}{} \times (H\underset{r,t}{} \times \sum_{t = 1}^{32}L\underset{y,t}{}) 
$$ {#eq-1}
...
$$
N\underset{n,r,t}{} = \frac{SD\underset{r,t}{} \times (H\underset{r,t}{} \times \sum_{t = 1}^{32}(L\underset{y,t}{} \times SS\underset{y}{}))}{AWT\underset{n,t}{}} 
$$ {#eq-3}
...
cost <- 
  ...
  mutate(cost = if_else(cadre == "Enfermeiro", 
                        abs_result * 15012.25,
                        abs_result * 28241.63)) |> 
